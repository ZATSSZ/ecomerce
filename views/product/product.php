<?php
    ...
    $product = [];
    $id = @$_GET['id'];
    $category = ["1" => "electronics", "2" => "fashion", "3" => "home appliance", "4" => "others"];
...
<?php if (isset($messSucc)){ ?> 
            ...
            <div class="row">
                <!-- Product Image -->
                <div class="col-md-6">
                    <img src="<?php echo BASE_URL.$product["image_url"]; ?>" alt="Product Image" class="img-fluid border border-secondary border-5" style="height:500px">
                </div>
